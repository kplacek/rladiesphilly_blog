...
categories: []
---
Shiny is an R Package that combines the computational power of R with the interactivity of the web to enable users to create interactive web apps (and dashboards!) in R. For our November meetup, Dr. Mine Çetinkaya-Rundel led a workshop introducing the basics of building dashboards using Shiny, and a demo on transitioning from dashboards to standalone apps. 

## Building interactive dashboards with Shiny and flexdashboard
A dashboard is an information management tool that tracks, analyzes and displays metrics and key data points, and can be static (i.e. an html page) or dynamic (i.e. user input updates data displayed in real time). Mine shared an example dashboard she created using Shiny and the flexdashboard pacakage to display data on Women in the United Nations (UN)...

![Women in the UN Dashboard](/Users/katerinaplacek/Documents/R/RLadies_Philly/rladiesphilly_blog/static/img/mine1.JPG)
...
Next, Mine moved on to how Shiny apps (like the dashboard on Women in the UN) actually work.
...
![Relationship between Server and UI](/Users/katerinaplacek/Documents/R/RLadies_Philly/rladiesphilly_blog/static/img/server_user.png)
